...
3. Initialize the weights for the 2 layer MLP with 2 Hidden neuron 
              and 1 output neuron
4.  Repeat the  iteration  until the losses become constant and 
              minimum
